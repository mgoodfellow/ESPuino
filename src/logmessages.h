...
extern const char newLoudnessReceived[];
...
extern const char lastFolderAlreadyActive[];
...
extern const char unableToCreateQueue[];
...
extern const char playlistRecDepth[];
