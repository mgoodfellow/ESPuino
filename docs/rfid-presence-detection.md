...
on RC522 clones. Earlier commits tried to paper over this with a growing
"consecutive misses" debounce (3 → 8 cycles ≈ 400 ms). That treats the symptom.
This note records the actual root cause and the fix now on this branch.
